...
/**
 * A special adapter to override the built-in Object adapter, which cannot be overridden in GSON.
 * This adapter covers special logic for mapping JSON values to Java objects.
 *
