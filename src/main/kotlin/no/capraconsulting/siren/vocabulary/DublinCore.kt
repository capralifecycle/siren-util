...
object DublinCore {
  ...
  /**
   * Uniquely identifies an entity or version by external relation (third party identifier). Can not
   * be changed on an existing entity
   */
  ...
  /**
   * Denotes when an entity was no longer valid (deleted). Also denotes the last available datetime
   * observation found in the corresponding data set of a part
   */
