 ...
 * but MUST also contain a rel attribute describing the relationship of the sub-entity to its
 * parent.
 *
 * **See also:**
 * [Embedded Representation specification](https://github.com/kevinswiber/siren.embedded-representation)
 *
 * @see Embedded
 * @see EmbeddedLink
 *
...
data class EmbeddedRepresentation(
  ...
  class Builder internal constructor(private var rel: List<String>) {
     ...
     * Set value for rel.
     *
     * @param rel Defines the relationship of the sub-entity to its parent, per Web Linking
     *   (RFC5899). Required.
     * @return builder
     */
  ...
  companion object {
     ...
     *   (RFC5899).
     */
    @JvmStatic fun newBuilder(rel: List<String>): Builder = Builder(rel)
     ...
     *   (RFC5899).
     */
    @JvmStatic fun newBuilder(rel: String): Builder = Builder(listOf(rel))
  }
}
